...
export const testCatalog: TestCase[] = [
  // Market Event NOT Live - Online Orders
  {
    ...
    description:
      'Complete online order flow: upload 1 photo, pay with credit card, ship to customer. Verify order appears in Order List with correct data.',
  ...
  },
  {
    ...
    description:
      'Complete online order flow: upload 1 photo, pay with Apple Pay, ship to customer. Verify payment amount is correct (not $0.00).',
    suite: 'Market Event NOT Live - Online Orders',
    suiteFile: 'market-event-not-live',
    category: 'Online Orders',
  ...
  },
  {
    ...
    description:
      'Complete online order with 15 photos: verify all photos upload, quantities are correct, and order total is accurate.',
    suite: 'Market Event NOT Live - Online Orders',
    suiteFile: 'market-event-not-live',
    category: 'Online Orders',
  ...
  },
  {
    ...
    description:
      'Complete online order with 15 photos using Apple Pay. Verify upload speed is reasonable and payment amount is correct.',
    suite: 'Market Event NOT Live - Online Orders',
    suiteFile: 'market-event-not-live',
    category: 'Online Orders',
  ...
  },
  {
    ...
    description:
      'Complete online order with local pickup option. Verify shipping address is not required and shipping cost is $0.00.',
    suite: 'Market Event NOT Live - Online Orders',
    suiteFile: 'market-event-not-live',
    category: 'Online Orders',
  ...
  // Market Event LIVE - User Toggles "At Event"
  {
    ...
    description:
      'User toggles "I\'m at the event" ON, uploads 1 photo, selects "Pay at Tent". Verify order shows pickup and pay at tent options.',
  ...
  },
  {
    ...
    description:
      'User toggles "I\'m at the event" ON, uploads 1 photo, selects "Pay Online Now". Verify checkout shows market event pickup notice.',
    suite: 'Market Event LIVE - User Toggles "At Event"',
    suiteFile: 'market-event-live',
    category: 'Market Events',
  ...
  },
  {
    ...
    description:
      'User toggles "I\'m at the event" ON, uploads 15 photos, selects "Pay at Tent". Verify all photos are saved and order is associated with event.',
    suite: 'Market Event LIVE - User Toggles "At Event"',
    suiteFile: 'market-event-live',
    category: 'Market Events',
    tags: [
  ...
  },
  {
    ...
    description:
      'User toggles "I\'m at the event" ON, uploads 15 photos, pays with Apple Pay. Verify order total is correct and delivery is pickup.',
    suite: 'Market Event LIVE - User Toggles "At Event"',
    suiteFile: 'market-event-live',
    category: 'Market Events',
    tags: [
  ...
  // Market Event LIVE - Popup Flow
  {
    ...
    description:
      'Market event is live, user has NOT toggled. Click "Start Creating Magnets", answer YES to popup. Verify navigation to market event upload.',
  ...
  },
  {
    ...
    description:
      'Market event is live, user has NOT toggled. Click "Start Creating Magnets", answer NO to popup. Verify navigation to online order flow.',
    suite: 'Market Event LIVE - User Does NOT Toggle (Popup Flow)',
    suiteFile: 'market-event-live',
    category: 'Market Events',
  ...
  },
  {
    ...
    description:
      'Market event is live, user explicitly toggles OFF. Click "Start Creating Magnets". Verify NO popup appears and goes directly to online order.',
    suite: 'Market Event LIVE - User Does NOT Toggle (Popup Flow)',
    suiteFile: 'market-event-live',
    category: 'Market Events',
  ...
  // Authenticated Users
  {
    ...
    description:
      'Authenticated user completes online order. Verify "View My Orders" button is visible on thank you page and order appears in Customer Orders.',
  ...
  },
  {
    ...
    description:
      'Authenticated user completes market event order. Verify order appears in both Customer Orders and Order List with correct market event info.',
    suite: 'Authenticated User Scenarios',
    suiteFile: 'authenticated-users',
    category: 'Authentication',
  ...
  // Data Integrity
  {
    ...
    description:
      'Verify orders are sorted by date (most recent first), search works for name/email, filters work correctly, and no invalid dates appear.',
  ...
  },
  {
    ...
    description:
      'Verify order receipt shows correct order number, customer info, total magnets, total amount, delivery option, and payment method.',
    suite: 'Data Integrity and Button Functionality',
    suiteFile: 'data-integrity',
    category: 'Data Integrity',
  ...
  },
  {
    ...
    description:
      'Verify all buttons on thank you page work: "Submit Another Order", "View My Orders" (if authenticated), and "Back to Home".',
    suite: 'Data Integrity and Button Functionality',
    suiteFile: 'data-integrity',
    category: 'Data Integrity',
  ...
  },
  {
    ...
    description:
      'Upload 15 photos and verify upload progress indicator shows, upload completes in reasonable time (< 60 seconds), and all photos are saved.',
    suite: 'Data Integrity and Button Functionality',
    suiteFile: 'data-integrity',
    category: 'Data Integrity',
  ...
  },
  {
    ...
    description:
      'Verify "Place Order" and "Buy with Apple Pay" buttons show loading/spinning state during processing and are disabled until navigation completes.',
    suite: 'Data Integrity and Button Functionality',
    suiteFile: 'data-integrity',
    category: 'Data Integrity',
  ...
  },
  {
    ...
    description:
      'Verify order totals are never $0.00 (unless actually free), payment amounts are correct, and cart calculations are accurate.',
    suite: 'Data Integrity and Button Functionality',
    suiteFile: 'data-integrity',
    category: 'Data Integrity',
  ...
  // Edge Cases
  {
    ...
    description:
      'Verify form validation works for all required fields (First Name, Last Name, Email), shows clear error messages, and only submits when valid.',
  ...
  },
  {
    ...
    description:
      'Verify market event toggle state persists across navigation. Toggle ON, navigate away and back, verify state is still ON (and same for OFF).',
    suite: 'Edge Cases and Error Handling',
    suiteFile: 'edge-cases',
    category: 'Edge Cases',
  ...
  },
  {
    ...
    description:
      'Create multiple orders and verify all order numbers are unique, follow expected format, and no duplicates exist in Order List.',
    suite: 'Edge Cases and Error Handling',
    suiteFile: 'edge-cases',
    category: 'Edge Cases',
